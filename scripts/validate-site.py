...
def validate_detail_page(
    ...
    if "Generated by scripts/build-content.py" not in html \
        and "Generated by scripts/build-projects.py" not in html \
        and "Generated by scripts/build-services.py" not in html:
        errors.append(f"{rel}: missing generated-file banner")
